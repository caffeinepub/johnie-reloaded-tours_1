...
Holding a Level One Guiding Certificate from the African Institute of Tourism and Field Guiding, I've led over 200 guided tours for international travelers, crafting custom itineraries that balance adventure, safety, and sustainability. My base in Kabale gives me unrivalled access to the Kigezi highlands, while my connections across Uganda and Rwanda make regional experiences seamless.`,
  ...
  services: [
    {
      ...
      description: "Expertly guided game drives and walking safaris through Uganda's finest national parks. Track lions, elephants, and hippos with a guide who reads the landscape like a native language."
    },
    {
      icon: "globe",
      title: "Cultural Tours",
      description: "Authentic village visits, traditional ceremonies, and local market explorations. Connect with Bakiga, Banyankole, and Baganda communities for a Uganda far beyond the guidebook."
    },
    {
      icon: "mountain",
      title: "Gorilla Trekking",
      description: "Unforgettable permit-guided treks into Bwindi Impenetrable Forest and Mgahinga. Spend precious time with mountain gorilla families in one of the world's most profound wildlife encounters."
    },
    {
      icon: "bird",
      title: "Birding Safaris",
      description: "Uganda hosts over 1,060 bird species. From the Shoebill Stork in Murchison Falls to the African Green Broadbill in Bwindi, let an expert guide turn every dawn chorus into a discovery."
    },
    {
      icon: "hike",
      title: "Adventure Hikes",
      description: "Guided ascents of the Virunga volcanoes, multi-day treks through the Rwenzori Mountains, and ridge walks above the Kigezi highlands. Challenging routes, breathtaking rewards."
    }
  ],
  // ---- Experience ----
  experience: [
  ...
  testimonials: [
    {
      quote: "John made our gorilla trekking experience absolutely magical. His knowledge of the forest and the gorillas was extraordinary — he spotted a silverback we would have walked right past!",
      author: "[Guest Name]",
      country: "[Country]",
      rating: 5
    },
    {
      quote: "An incredible guide with deep cultural knowledge. Our village visit was the highlight of our entire trip to Uganda. John connected us with local families in the most genuine way.",
      author: "[Guest Name]",
      country: "[Country]",
      rating: 5
    },
    {
      quote: "Professional, warm, and genuinely passionate about Uganda. Johnie made us feel safe and amazed throughout every safari. We will absolutely be back — and we'll book through him again.",
      author: "[Guest Name]",
      country: "[Country]",
      rating: 5
    }
...
function About() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "texture-sand py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brown text-xs tracking-[0.3em] uppercase font-medium", children: "Who I Am" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-72 sm:w-80 lg:w-96", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-2 border-2 border-gold rounded-xl opacity-40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-4 border border-gold/20 rounded-2xl" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-4 left-1/2 -translate-x-1/2 bg-forest text-sand text-xs px-4 py-2 rounded-full tracking-widest uppercase whitespace-nowrap shadow-lg", children: [
              "📍 ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl lg:text-5xl font-bold text-forest uppercase tracking-wide mb-6", children: "About Me" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-gold mb-8" }),
            bioParagraphs.map((para) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "relative my-8 pl-6 border-l-4 border-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-xl italic text-forest", children: [
              "“",
              siteContent.quote,
              "”"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-4 mt-8", children: siteContent.stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "bg-forest text-sand px-6 py-4 rounded-xl text-center shadow-card min-w-[110px]",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-3xl font-bold text-gold", children: stat.value }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs tracking-widest uppercase mt-1 text-sand/70", children: stat.label })
                ]
              },
              stat.label
            )) })
...
const Binoculars = createLucideIcon("binoculars", __iconNode$i);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Bird = createLucideIcon("bird", __iconNode$h);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PersonStanding = createLucideIcon("person-standing", __iconNode$3);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function UgandaMap() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Map of Uganda showing Kampala and Kabale locations" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "205", y: "295", fontSize: "8", fill: "#3a7aad", fontStyle: "italic", children: "L. Victoria" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            cx: "158",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M158 195 L158 215", stroke: "#D4A017", strokeWidth: "2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "158", cy: "217", r: "2", fill: "#D4A017" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
          {
            x: "120",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M100 268 L100 288", stroke: "#D4A017", strokeWidth: "2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "100", cy: "290", r: "2", fill: "#D4A017" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
          {
            x: "66",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M255 58 L255 72", stroke: "#0B5A3A", strokeWidth: "1.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "bg-brown py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold/60" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold/70 text-xs tracking-[0.3em] uppercase font-medium", children: "Get In Touch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold/60" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl lg:text-5xl font-bold text-sand uppercase tracking-wide", children: "Contact & Booking" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-gold mx-auto mt-5" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-8", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-4 py-12 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 56, className: "text-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-sand", children: "Thank You!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sand/70", children: "Johnie will be in touch soon." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-sand mb-6", children: "Book a Safari" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  errors.name && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-400 text-xs mt-1", children: errors.name })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "label",
                  ...
                  errors.email && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-400 text-xs mt-1", children: errors.email })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "label",
                  ...
                  errors.message && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-400 text-xs mt-1", children: errors.message })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-3", children: [
              siteContent.phones.map((phone) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: `tel:${phone.replace(/\s/g, "")}`,
                  className: "flex items-center gap-3 text-sand/70 hover:text-gold transition-colors text-sm",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 15, className: "text-gold flex-shrink-0" }),
                    phone
                  ]
                },
                phone
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  ...
                  className: "flex items-center gap-3 text-sand/70 hover:text-gold transition-colors text-sm",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 15, className: "text-gold flex-shrink-0" }),
                    siteContent.email
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 pt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { size: 15, className: "text-gold" }),
                      " Instagram"
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    className: "flex items-center gap-2 text-sand/70 hover:text-gold transition-colors text-sm",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Facebook, { size: 15, className: "text-gold" }),
                      " Facebook"
                    ]
                  }
                )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/10 border border-white/15 rounded-2xl p-6 h-full min-h-[400px] flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 18, className: "text-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-sand", children: "Based In Uganda" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 rounded-xl overflow-hidden bg-sand/5 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UgandaMap, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 mt-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sand/60 text-xs", children: [
...
function Education() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "education", className: "texture-sand py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brown text-xs tracking-[0.3em] uppercase font-medium", children: "Academic Background" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl lg:text-5xl font-bold text-forest uppercase tracking-wide", children: "Education" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-gold mx-auto mt-5" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: siteContent.education.map((edu, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 sm:left-6 -translate-x-1/2 w-5 h-5 rounded-full bg-forest border-2 border-gold flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 9, className: "text-gold" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white border border-forest/10 rounded-xl p-5 shadow-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-forest", children: edu.institution }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/60 text-sm mt-0.5", children: edu.qualification })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-forest/8 text-forest text-xs px-3 py-1 rounded-full tracking-wide font-medium", children: edu.level })
            ] }) })
          ]
        },
        edu.institution
...
function Experience() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "experience", className: "bg-forest py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold/60" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold/70 text-xs tracking-[0.3em] uppercase font-medium", children: "Career" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold/60" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl lg:text-5xl font-bold text-sand uppercase tracking-wide", children: "Experience" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-gold mx-auto mt-5" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-10", children: [
        siteContent.experience.map((exp, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, x: -20 },
            whileInView: { opacity: 1, x: 0 },
            ...
            className: "relative pl-16 sm:pl-20",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 sm:left-6 -translate-x-1/2 w-5 h-5 rounded-full bg-gold border-2 border-forest flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { size: 9, className: "text-forest" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-forest-dark/60 border border-gold/20 rounded-xl p-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2 mb-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-gold", children: exp.company }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sand/70 text-sm font-medium", children: exp.role })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-gold/20 text-gold text-xs px-3 py-1 rounded-full tracking-wide font-medium", children: exp.period })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: exp.highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "li",
                  {
                    className: "text-sand/60 text-sm flex items-start gap-2",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold mt-1.5 text-xs", children: "▸" }),
                      h
                    ]
                  },
                  h
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            className: "relative pl-16 sm:pl-20",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 sm:left-6 -translate-x-1/2 w-5 h-5 rounded-full bg-gold border-2 border-forest flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { size: 9, className: "text-forest" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gold/10 border border-gold/40 rounded-xl p-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { size: 20, className: "text-gold flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-bold text-gold", children: siteContent.certification.title })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sand/70 text-sm", children: siteContent.certification.issuer }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block mt-2 bg-gold/20 text-gold text-xs px-3 py-1 rounded-full tracking-wide", children: siteContent.certification.year })
              ] })
            ]
          }
        )
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-forest-dark text-sand/70", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl font-bold text-gold tracking-widest uppercase mb-3", children: siteContent.shortName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sand/60 text-sm leading-relaxed mb-4", children: siteContent.tagline }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sand/50 text-xs", children: siteContent.location })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-bold text-sand uppercase tracking-widest mb-4", children: "Quick Links" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-bold text-sand uppercase tracking-widest mb-4", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
          siteContent.phones.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: `tel:${p.replace(/\s/g, "")}`,
              className: "flex items-center gap-2 text-sand/50 hover:text-gold text-sm transition-colors",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 13, className: "text-gold/60" }),
                " ",
                p
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              className: "flex items-center gap-2 text-sand/50 hover:text-gold text-sm transition-colors",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 13, className: "text-gold/60" }),
                " ",
                siteContent.email
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3 pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: siteContent.instagram,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-sand/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "© ",
      year,
      " ",
      siteContent.name,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(to bottom, rgba(5,30,20,0.72) 0%, rgba(8,50,30,0.60) 50%, rgba(5,20,10,0.85) 100%)"
            },
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto pt-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold text-xs tracking-[0.3em] uppercase font-medium", children: "Uganda & Rwanda" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-12 bg-gold" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl sm:text-5xl lg:text-7xl font-bold text-white leading-tight tracking-wide uppercase mb-4", children: siteContent.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold text-lg sm:text-xl font-medium tracking-widest uppercase mb-1", children: siteContent.role }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold/80 text-base sm:text-lg font-medium tracking-widest uppercase mb-8", children: siteContent.roleLocation }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/80 text-xl sm:text-2xl font-display italic mb-10", children: [
                "“",
                siteContent.tagline,
                "”"
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-center gap-4 text-white/70", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/40 text-xs tracking-widest uppercase", children: "Scroll" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-10 bg-gradient-to-b from-gold/60 to-transparent" })
        ] })
      ]
    }
  );
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-forest shadow-lg" : "bg-forest/95 backdrop-blur-sm"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: siteContent.shortName
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-forest-dark border-t border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col px-4 py-4 gap-1", children: [
...
const iconMap = {
  binoculars: /* @__PURE__ */ jsxRuntimeExports.jsx(Binoculars, { size: 32, strokeWidth: 1.5 }),
  globe: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 32, strokeWidth: 1.5 }),
  mountain: /* @__PURE__ */ jsxRuntimeExports.jsx(Mountain, { size: 32, strokeWidth: 1.5 }),
  bird: /* @__PURE__ */ jsxRuntimeExports.jsx(Bird, { size: 32, strokeWidth: 1.5 }),
  hike: /* @__PURE__ */ jsxRuntimeExports.jsx(PersonStanding, { size: 32, strokeWidth: 1.5 })
};
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "bg-sand py-20 lg:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brown text-xs tracking-[0.3em] uppercase font-medium", children: "What I Offer" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl lg:text-5xl font-bold text-forest uppercase tracking-wide", children: "Services & Specialties" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-gold mx-auto mt-5" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: siteContent.services.map((service, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-xl bg-forest/8 flex items-center justify-center text-forest group-hover:bg-gold group-hover:text-white transition-all duration-300 mb-5", children: iconMap[service.icon] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-forest mb-3 uppercase tracking-wide", children: service.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 text-sm leading-relaxed", children: service.description })
        ]
      },
      service.title
    )) })
...
function Testimonials() {
  ...
  const prev = () => {
    setCurrent((prev2) => (prev2 - 1 + total) % total);
  };
  reactExports.useEffect(() => {
    if (paused) return;
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-hidden": "true",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-[12rem] lg:text-[18rem] font-bold text-brown/[0.04] uppercase leading-none", children: "UGANDA" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brown text-xs tracking-[0.3em] uppercase font-medium", children: "Guest Stories" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-gold" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl lg:text-5xl font-bold text-forest uppercase tracking-wide", children: "Testimonials" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-gold mx-auto mt-5" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-1 mb-6", children: [1, 2, 3, 4, 5].slice(0, testimonial.rating).map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 20, className: "text-gold fill-gold" }, n)) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-7xl text-gold/25 leading-none mb-2", children: "“" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl lg:text-2xl italic text-forest leading-relaxed mb-8", children: testimonial.quote }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-forest text-sm tracking-wide", children: testimonial.author }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground/50 text-xs tracking-widest uppercase", children: testimonial.country })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-8 bg-gold" })
                      ] })
                    ]
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mt-8", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: siteContent.testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      onClick: () => setCurrent(i),
                      className: `w-2 h-2 rounded-full transition-all duration-200 ${i === current ? "bg-gold w-6" : "bg-gold/30"}`,
                      "aria-label": `Go to testimonial ${i + 1}`
                    },
                    t.author + t.country + String(i)
                  )) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
